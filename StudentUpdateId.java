...
public class StudentUpdateId extends JDialog implements ActionListener
{
	...
	public StudentUpdateId(String id)
	{
		this.id=id;
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(ob==tsubmit)
		{
			...
			String mail2=FEmail.getText();
			String Adhar= tAdhar.getText();
			String email=tEmail.getText();
			String Mob=tMobile.getText();
			String Mob2=tFMobile.getText();
			String Ad= tAdhar.getText();
			
			String s= "update stacademicdetail set Address=?, Adhar_No=?, EMail=?, Mobile=?,PMobile=?,PEmail=?,Adhar_No=? where Er_No=?";
